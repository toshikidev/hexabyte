...
const isoDatetime = computed(() => lastUpdatedDate.value ? lastUpdatedDate.value.toISOString() : '')
const timeFormNow = computed(() => isoDatetime.value ? getFromNow(isoDatetime.value) : 'Unknown')
</script>
